...
const PRECACHE_URLS = [
  ...
  // Same on-demand-but-precached deal for the prosthetic valve reference
  // data (see prosthetic-data/ and loadProstheticAorticValves() in app.js).
  './prosthetic-data/aortic-valves.js',
  './manifest.json',
